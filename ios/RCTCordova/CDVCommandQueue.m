...
#import <WebKit/WebKit.h>     // for WKWebView evalJS
...
- (BOOL)execute:(CDVInvokedUrlCommand*)command
{
    ...
    // Fetch an instance of this pluign class
    CDVPlugin* obj = nil;
    CDVCommandDelegateImpl *commandDelegate = nil;

    if([_viewController respondsToSelector:@selector(commandDelegate)])
      commandDelegate = [_viewController performSelector:@selector(commandDelegate)];
    if(commandDelegate)
      obj = [commandDelegate getCommandInstance:command.className];
